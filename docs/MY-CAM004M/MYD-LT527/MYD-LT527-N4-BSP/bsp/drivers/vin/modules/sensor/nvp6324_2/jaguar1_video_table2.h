 ...
 * Video Initialize Structure
 ==============================================================*/
typedef struct NC_VD_VI_Init_STR2{
	char *name;
...
typedef struct NC_VD_VO_Init_STR2{
	char *name;
 ...
 *======================================================= */
typedef struct NC_VD_Jaguar1_Init_STR2{
	char *name;
...
NC_VD_VI_Init_STR2 vd_vi_init_list2[] = {
...
NC_VD_VO_Init_STR2 vd_vo_init_list2[] = {
...
NC_VD_Jaguar1_Init_STR2 vd_jaguar1_init_list2[] = {
