 ...
 * Coaxial UP/Down stream initialize structure
 ==============================================================*/
typedef struct NC_VD_COAX_Init_STR2{
	char *name;
	unsigned char ch;
	...
	int shot_delay;
	int reset_delay;
} NC_VD_COAX_Init_STR2;

/*=============================================================
 * Coaxial UP/Down stream command structure
 ==============================================================*/
typedef struct NC_VD_ACP_CMDDEF_STR2 {
	char *name;
	int ahd_16bit[16];
	int ahd_8bit[16];
	int ahd_4_5m[32];
	...
	int tvi_v2_0[16];
	int sd[16];
} NC_VD_ACP_CMDDEF_STR2;

NC_VD_COAX_Init_STR2 coax_acp_16bit_init_lists2[] = {
	[AHD20_720P_30P2] = {
		.name = "AHD20_720P_30P2",
		.ch			   = 0,
		.rx_src		   = 0x01,
		.rx_slice_lev	   = 0x80,
		.tx_bank           = 0x02,
...
NC_VD_COAX_Init_STR2 coax_init_lists2[] = {

	[AHD20_SD_H9602EX_Btype_NT2] = {
		.name = "AHD20_SD_H9602EX_Btype_NT2",
		.ch                = 0,
		.rx_src            = 0x01,
		.rx_slice_lev      = 0x80,
		.tx_bank           = 0x02,
	...
	[AHD20_SD_H9602EX_Btype_PAL2] = {
		.name = "AHD20_SD_H9602EX_Btype_PAL2",
		.ch                = 0,
		.rx_src            = 0x01,
		.rx_slice_lev      = 0x80,
		.tx_bank           = 0x02,
...
NC_VD_ACP_CMDDEF_STR2 coax_cmd_lists2[] = {
