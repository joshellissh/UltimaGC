...
struct v4l2_subdev *nvp6324_sd2;
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	if (wsize->fps_fixed == 60)
		nvp6324_init2(AHD20_720P_60P);
	else if (wsize->fps_fixed == 25) {
		if (wsize->width == 1920 && wsize->height == 1080)
			nvp6324_init2(AHD20_1080P_25P);
		else
			nvp6324_init2(AHD20_720P_25P_EX_Btype);
	} else {
		if (wsize->width == 1920 && wsize->height == 1080)
			nvp6324_init2(AHD20_1080P_30P);
		else
			nvp6324_init2(AHD20_720P_30P_EX_Btype);
	}
			...
			const struct i2c_device_id *id)
{
	...
	gpio_direction_output(386,0);

	usleep_range(20000, 25000);
	gpio_direction_output(386,1);
	return 0;
}
