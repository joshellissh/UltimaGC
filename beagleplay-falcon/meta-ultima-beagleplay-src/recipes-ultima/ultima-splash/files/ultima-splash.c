 ...
 * /dev/dri/card0: see beagleplay-falcon/NOTES.md "Boot splash implemented
 * and hardware-verified" -- this is the same proven pixel path, now
 * blitting real artwork instead of a procedural test pattern.
 *
