...
SRC_URI:append = " file://0002-arm64-dts-k3-am625-beagleplay-add-mycam004m-camera.patch"
...
KERNEL_CONFIG_FRAGMENTS += "${WORKDIR}/ultima-can.cfg ${WORKDIR}/ultima-display.cfg ${WORKDIR}/ultima-wifi.cfg"
